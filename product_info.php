...
<img src="http://localhost/xike<?php echo $row_image['thumb']; ?>"  width="184" height="184" id="middlepic" /></a>
                    </div>
                    ...
                    <div class="prdo4">
                        ...
                        <div class="prdo7 clearfix">
                            <div class="prdo9" id="box">
								...
								?>
                                     <li><a class="prdo9oa" href="javascript:void(0)" id="tt1"  onmouseover="showlink(1,'http://localhost/xike<?php echo $e_smalls[0]; ?>','<?php echo $e_smalls[0]; ?>')"><img src="http://localhost/xike<?php echo $e_smalls[0]; ?>"  width="63" height="63" /></a></li>
							    <?php } ?>
                                </ul>
                            </div>
