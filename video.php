		...
		<div>
            ...
            <div class="pzp1" style=" width:916px;">
				...
				?>
							 <ul class="clearfix">
								<li class="clearfix">
								1.摄像机远程访问端口映射的操作方法<br />
								<a href="http://v.youku.com/v_show/id_XNDI2OTczODUy.html" target="_blank">点击播放视频教程</a>
								</li>
							</ul>
				<?php
						break;
				...
				?>
							 <ul class="clearfix">
								...
								1.在UC2中升级摄像机模组的固件<br />
								<a href="http://v.ku6.com/show/j92WOXpQ14T--6Sa-iJIHg...html?from=my#share" target="_blank">点击播放视频教程</a>
								</li>
								<li class="clearfix" style="height:80px;">
								2.在UC2中搜索摄像机方法<br />
								<a href="http://v.ku6.com/show/7x8vl23HL2Nzj_6wWAmH7w...html?from=my#share" target="_blank">点击播放视频教程</a>
								</li>
								<li class="clearfix" style="height:80px;">
								3.在UC2中统一摄像机的时间<br />
								<a href="http://v.ku6.com/show/pC6QIzLyQaZfB2f3m0WBhQ...html?from=my#share" target="_blank">点击播放视频教程</a>
								</li>
								<li class="clearfix" style="height:80px;">
								4.在UC2中修改摄像机IP地址<br />
								<a href="http://v.ku6.com/show/E1M-JOJwDGhurKcnxD-FiQ...html?from=my#share" target="_blank">点击播放视频教程</a>
								</li>
								<li class="clearfix" style="height:80px;">
								5.在UC2中音频监听的操作方法<br />
								<a href="http://v.youku.com/v_show/id_XNDI1Mjg1Nzcy.html" target="_blank">点击播放视频教程</a>
								</li>
								<li class="clearfix" style="height:80px;">
								6.在UC2中查询录像的操作方法<br />
								<a href="http://v.youku.com/v_show/id_XNDI2MDc4NTIw.html" target="_blank">点击播放视频教程</a>
								</li>
								<li class="clearfix" style="height:80px;">
								7.在UC2中实现前端摄像机移动侦测录像的过程<br />
								<a href="http://v.youku.com/v_show/id_XNDI2MDc4OTY0.html" target="_blank">点击播放视频教程</a>
								</li>
							</ul>
				<?php
						break;
				...
				?>
							<ul class="clearfix">
								<li class="clearfix">
								1.NVR开机配置（更改IP与磁盘格式化）<br />
								<a href="http://v.youku.com/v_show/id_XNDIzODI2MzY4.html" target="_blank">点击播放视频教程</a>
								</li>
							</ul>
				<?php 
						break;
