            ...
            <div class="pzp1" style=" width:916px;">
                ...
                <div class="mtgzxw1">
                    <ul class="clearfix">
                                ...
                                <?php 
									$sql_d = "select * from yourphp_download where catid = '".$id."'";
									//echo $sql_d;
									$result_d = mysql_query($sql_d);
									while($obj_d = mysql_fetch_array($result_d)){
								?>
                                <li class="clearfix">
                                <a href="download_a.php?did=<?php echo $obj_d['id']; ?>"><?php echo $obj_d["title"]?></a>
                                </li>
                            	<?php 
									}
								?>
