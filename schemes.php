		...
		<div class="xgy9">
			...
			<div class="zjsj" style="height:336px;">
				...
				<div class="xgdg9 clearfix">
					<div class="nbrbodynewl" style="width:140px;height:80px;"><a href="newshd_<?php echo $row_article['id']; ?>.html"><img src="http://localhost/xike/<?php echo $row_article['thumb']; ?>" width="140" height="80" /></a></div>
					<div class="xgdg6">
