...
<div class="newsbody clearfix">
  ...
  ?>
          <div class="jjfajsh1">
            <div class="prdltop4">
              <div class="jjfajsh2"><a href="product_info<?php echo $getid; ?>_<?php echo $obj_product["id"] ?>.html"><img  src="http://localhost/xike<?php echo $obj_product['thumb']; ?> " width="185" height="185" /></a>
    ...
    <div class="jjfajshh4"><?php echo $obj_product["description"]; ?></div>
            ...
            <div class="jjfajsh4"><a href="product_info<?php echo $getid; ?>_<?php echo $obj_product["id"] ?>.html"> 了解详细+</a></div>
          </div>
          <?php
   }
  ?>
